...
name,weekA = jsonparser.parse(expanduser("~/GIT/Pdf2TimeTable/Pdf2TimeTable/test2/timetable_week_a.json"))
name,weekB = jsonparser.parse(expanduser("~/GIT/Pdf2TimeTable/Pdf2TimeTable/test2/timetable_week_b.json"))
prepared_data = {
        'Week A':weekA,
        'Week B':weekB}
pprint(prepared_data)
writer.write_prepared_data_to_excel(name, prepared_data, "test2/output.xlsx")
